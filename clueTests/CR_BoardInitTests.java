...
public class CR_BoardInitTests {
	...
	public void testRooms() {
		Map<Character, String> rooms = board.getRooms("ClueLegend.txt");
	...
	public void FourDoorDirections() {
		...
		RoomCell cell2 = new RoomCell(cell);
	...
	public void testRoomInitials() {
		assertEquals('C', board.getRoomCellAt(0, 0).getType());
		assertEquals('R', board.getRoomCellAt(4, 8).getType());
		assertEquals('B', board.getRoomCellAt(9, 0).getType());
		assertEquals('O', board.getRoomCellAt(21, 22).getType());
		assertEquals('K', board.getRoomCellAt(21, 0).getType());
	}
	...
	public void testBadColumns() throws BadConfigFormatException, FileNotFoundException {
		...
		b.loadRoomConfig("ClueLegend.txt");
		b.loadBoardConfig("ClueLayoutBadColumns.csv");
	}
	// Test that an exception is thrown for a bad config file
	@Test (expected = BadConfigFormatException.class)
	public void testBadRoom() throws BadConfigFormatException, FileNotFoundException {
		...
		b.loadRoomConfig("ClueLegend.txt");
		b.loadBoardConfig("ClueLayoutBadRoom.csv");
	}
	// Test that an exception is thrown for a bad config file
	@Test (expected = BadConfigFormatException.class)
	public void testBadRoomFormat() throws BadConfigFormatException, FileNotFoundException {
		...
		b.loadRoomConfig("ClueLegendBadFormat.txt");
		b.loadBoardConfig("ClueLayout.csv");
	}
